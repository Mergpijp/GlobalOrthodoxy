...
from .models import Publication, FormOfPublication, Author, Translator, Church
...
class NewCrispyForm(forms.ModelForm):
    ...
    translator = forms.ModelMultipleChoiceField(queryset=Translator.objects.all())
    affiliated_church = forms.ModelMultipleChoiceField(queryset=Church.objects.all())
