        ...
        self.helper.layout = Layout(
            TabHolder(
                ...
                Tab('Language',
                    ...
                    #                                          onClick="window.open('/language/new', '_blank', 'width=1000,height=600,menubar=no,toolbar=no');")),
                    'language',
                    HTML("""{% include "_language_modal2.html" %}"""),
                    ),
                Tab('Publishing information',
                    ...
                    'form_of_publication',
                    HTML("""{% include "_form_of_publication_modal.html" %}"""),
                    'ISBN_number',
                    'printed_by',
                    'published_by',
                    'is_periodical',
                ...
                Tab('Affiliation',
                    ...
                    'affiliated_church',
                    HTML("""{% include "_church_modal.html" %}"""),
                    'extra_info',
                    ),
                Tab('Content',
                    'content_description',
                    ...
                    'content_genre',
                    HTML("""{% include "_content_genre_modal.html" %}"""),
                    'connected_to_special_occasion',
                    HTML("""{% include "_special_occasion_modal.html" %}"""),
                    'description_of_illustration',
                    'nr_of_pages',
                ...
                Tab('Collection info',
                    ...
                    'currently_owned_by',
                    HTML("""{% include "_owned_by_modal.html" %}"""),
                    'contact_telephone_number',
                    'contact_email',
                    'contact_website',
                    ),
...
class UploadedFileForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            HTML('<p>Main colors</p>'),
            HTML('<div class="color-dot" style="background-color: {{ object.main_color }};"></div>'),
            HTML('<div class="color-dot" style="background-color: {{ object.secondary_color }};"></div>'),
            'image_contents',
