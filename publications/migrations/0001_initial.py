    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('direction', models.CharField(choices=[('Left', publications.models.WritingDirection.Left, ('Right', publications.models.WritingDirection.Right))], default='Right', max_length=5)),
            ],
        ),
        migrations.CreateModel(
            name='Location',
