...
urlpatterns = [
    ...
    path('author/<int:pk>/edit/None', login_required(views.AuthorUpdate.as_view()), name='author-update'),
    ...
    path('translator/<int:pk>/edit/None', login_required(views.TranslatorUpdate.as_view()), name='translator-update'),
    ...
    path('uploadedfile/<int:pk>/edit/None', login_required(views.UploadedFileUpdate.as_view()), name='uploadedfile-update',),
