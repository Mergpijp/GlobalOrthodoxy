...
urlpatterns = [
    ...
    path('image_detail/new/', login_required(views.ImageDetailCreate.as_view()), name='image-detail-new'),
    path('image_detail/show/', login_required(views.ImageDetailShow.as_view()), name='image-detail-show'),
    path('image_detail/<int:pk>/edit/', login_required(views.ImageDetailUpdate.as_view()), name='image-detail-update', ),
    path('image_detail/<int:pk>/delete/', views.ImageDetailDelete, name='image-detail-delete'),
