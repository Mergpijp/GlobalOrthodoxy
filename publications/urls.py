...
urlpatterns = [
    ...
    path('new_authors/', views.AuthorShow.as_view(), name='authors-show-new'),
    path('new_filecategories/', views.FileCategoryShow.as_view(), name='filecategories-show-new'),
    path('new_form_of_publications/', views.FormOfPublicationShow.as_view(), name='authors-show-new'),
    path('new_genres/', views.GenreShow.as_view(), name='genres-show-new'),
    path('new_keywords/', views.KeywordShow.as_view(), name='keywords-show-new'),
    path('new_owners/', views.OwnerShow.as_view(), name='owners-show-new'),
    path('new_cities/', views.CityShow.as_view(), name='cities-show-new'),
    path('new_specialoccasions/', views.SpecialOccasionShow.as_view(), name='specialoccasions-show-new'),
    path('new_translators/', views.TranslatorShow.as_view(), name='translators-show-new'),
    path('new_uploadedfiles/', views.UploadedFileShow.as_view(), name='uploadedfiles-show-new'),
