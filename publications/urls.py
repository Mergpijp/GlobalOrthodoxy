...
urlpatterns = [
    ...
    path('filecategory/show/', views.FileCategoryShow.as_view(), name='filecategory-show'),
    ...
    path('imagecontent/show/', views.ImageContentShow.as_view(), name='imagecontent-show'),
    path('imagecontent/<int:pk>/edit/', login_required(views.ImageContentShow.as_view()),
         name='imagecontent-update', ),
